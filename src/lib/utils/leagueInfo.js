/*   STEP 1   */
export const leagueID = "1180609832595107840"; // your league ID
export const leagueName = "Champions League"; // your league name
...
export const homepageText = `
  <p>Welcome to the Champions League Home Page. All displayed data is updated in real-time.</p>
...
export const managers = [
        ...
        },
  {
    ...
    },
    {
      ...
      "name": "Joshua Teixeira",
      "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Modesto, CA", // (optional)
      "bio": null,
      "photo": null, // square ratio recommended (no larger than 500x500)
      "fantasyStart": null, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "sf", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
        ...
        },
  {
    ...
    },
    {
      ...
      "name": "Dave Twomey",
      "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Copperopolis, CA", // (optional)
      "bio": null,
      "photo": null, // square ratio recommended (no larger than 500x500)
      "fantasyStart": null, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "lv", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
